      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-transparent to-purple-50 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
              <div className="relative">
                <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-100 text-3xl transition-transform duration-500 group-hover:scale-105">
                  {service.icon}
                </div>
              ...
              <a
                ...
                className="relative inline-flex items-center text-blue-600 font-semibold transition-all duration-300 group-hover:gap-2"
              >
                Read More
